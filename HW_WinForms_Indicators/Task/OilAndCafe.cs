...
namespace Task
{
    public partial class OilAndCafe : Form
    {
        ...
        private void RuMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void KzMenuItem_Click(object sender, EventArgs e)
        {
            Thread.CurrentThread.CurrentCulture = new CultureInfo("kk");
            Thread.CurrentThread.CurrentUICulture = new CultureInfo("kk");
            ComponentResourceManager resources = new ComponentResourceManager(this.GetType());
            resources.ApplyResources(this, "$this");
            foreach (Control c in this.Controls)
                resources.ApplyResources(c, c.Name);
            languageButton.Text = "Каз";
        }
    }
}
